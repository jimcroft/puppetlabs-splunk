# Class: splunk::master
#
# This class deploys Splunk as a cluster master on Linux, Windows, Solaris 
# platforms. There should be only one master per cluster.
#
# Parameters:
#
...
# Actions:
#
#   Configures the Splunk server.conf file for cluster master mode.
#
# Requires: nothing
#
class splunk::master
